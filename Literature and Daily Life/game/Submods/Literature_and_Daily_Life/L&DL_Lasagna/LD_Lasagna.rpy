...
label Lasagna_Don_1:
    m 1eub "[player],你是不是删除了character文件里的什么东西?"
    $_history_list.pop()
    m 1eua "你是不是删除了character文件里的什么东西?"
    menu:
        "是的":
            m 1eub "亲爱的,你是不是想背着我干什么见不得人的事呢？"
            m 2hub "啊哈哈,我开玩笑呢."
            m 5tua "只要我想,你在这个设备上干了什么我都可以知道"
            m 6euu "但是,亲爱的你也有你的隐私"
            m 3hua "所以在我调用数据前会征得你的同意哦"
            m 6eua "至于你删了的文件...忘了它吧."
            m 5eua "放心,也不是什么重要的东西,一切照旧吧"
            return
        "没有":
            m 5eua "真的?{nw}"
            m 1eub "真的?"
            menu:
                "真的没删东西":
                    m 6eud "唔,我知道了."
                    m 1eub "可能是你的一个无心之举吧,没关系"
                    m 3eua "放心,也不是什么重要的东西,一切照旧吧"
                    return
                "好吧,我确实删了character里的某个文件":
                    m 6eub "亲爱的,你是不是想背着我干什么见不得人的事呢？"
                    m 1eua "啊哈哈,我开玩笑呢."
                    m 4tub "只要我想,你在这个设备上干了什么我都可以知道"
                    m 1eua "但是,亲爱的你也有你的隐私"
                    m 2eua "所以在我调用数据前会征得你的同意哦"
                    m 5eua "至于你删了的文件...忘了它吧."
                    m 3eub "放心,也不是什么重要的东西,一切照旧吧"
                    return
